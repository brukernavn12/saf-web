...
-- Fri tekst per reise, f.eks. "Opptil 12 deltagere" / "Up to 12 participants".
...
comment on column trips.group_size_no is
  'Synlig gruppestørrelse på reisesiden, f.eks. "Opptil 12 deltagere".';
comment on column trips.group_size_en is
  'Visible group size on English trip page, e.g. "Up to 12 participants".';

update trips set group_size_no = 'Opptil 8 deltagere', group_size_en = 'Up to 8 participants', updated_at = now()
